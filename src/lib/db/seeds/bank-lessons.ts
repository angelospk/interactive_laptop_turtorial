...
export const bankLessons: NewLesson[] = [
	// 1. Concept: how do I know a bank page is safe? (padlock + https)
	{
		...
		lessonType: 'quiz',
		config: {
			question: 'Πώς καταλαβαίνετε ότι η ιστοσελίδα της τράπεζας είναι ασφαλής;',
			explanation:
				'Σωστά! Το λουκετάκι 🔒 και η διεύθυνση που ξεκινά με «https://» δείχνουν ότι η σύνδεση είναι κρυπτογραφημένη και ασφαλής.',
			options: [
