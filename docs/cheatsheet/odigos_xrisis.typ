...
#card("Λιγότερες διαφημίσεις", "🛡️", rgb("#7c3aed"))[
  ...
  #tip[Στις *Ρυθμίσεις*, στην αναζήτηση (φακός) γράψτε «*DNS*» και ανοίξτε το *Ιδιωτικό DNS (Private DNS)*.]
  #tip[Επιλέξτε «όνομα κεντρικού υπολογιστή» και γράψτε: #box(fill: luma(244), inset:(x:3pt,y:1pt), radius:2pt)[`dns.adguard.com`]]
...
#card("Αν χαθεί το κινητό (Android)", "📍", rgb("#0d9488"))[
  #ok[*Ενεργοποιήστε από τώρα*: στις *Ρυθμίσεις*, στην αναζήτηση γράψτε «*Εύρεση συσκευής*» και βάλτε το σε *ON*.]
...
#card("Δείτε καλύτερα την οθόνη", "🔍", rgb("#2563eb"))[
  ...
  #tip[*Πιο μεγάλα γράμματα*: στις *Ρυθμίσεις*, στην αναζήτηση γράψτε «*Μέγεθος κειμένου*».]
