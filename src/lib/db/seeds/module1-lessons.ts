...
export const module1Lessons: NewLesson[] = [
	...
	// Lesson 6: Scroll Adventure
	{
		...
		// Disabled at the owner's request, not because it is broken: the config
		// passes the playability contract and ScrollLesson renders it. Re-enable
		// is a content decision -- see docs/LESSON_REVIEW.md.
		enabled: false,
