...
export const module6Lessons: NewLesson[] = [
	...
	},
	{
		...
		config: {
			...
			initialApps: ['email'],
			instructions:
				'Κάντε κλικ σε κάθε μη αναγνωσμένο μήνυμα (με έντονη γραμματοσειρά) για να το διαβάσετε.\n\n💡 Τα μη αναγνωσμένα μηνύματα έχουν έντονο τίτλο.',
			emails: [
				{
					id: 'e1',
					sender: 'Γιάννης <giannis@gmail.com>',
					subject: 'Καλημέρα!',
					body: 'Τι κάνεις; Πάμε για καφέ;',
					date: '10:00',
					isRead: false,
					isPhishing: false
				},
				{
					id: 'e2',
					sender: 'Μαρία <maria@gmail.com>',
					subject: 'Συνάντηση αύριο',
					body: 'Θες να βρεθούμε αύριο στις 5;',
					date: '09:30',
					isRead: false,
					isPhishing: false
				}
	...
	// Lesson 6: Email Attachments
	{
		...
		config: {
			...
			availableFiles: [{ id: 'doc1', name: 'Έγγραφο.pdf', size: '1.2 MB' }]
		},
		enabled: true,
