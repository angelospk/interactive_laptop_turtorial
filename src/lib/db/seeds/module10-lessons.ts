		...
		config: {
			...
			cards: [
				...
				},
				{
					...
					takeaway:
						'Νόμιμο μήνυμα. Καλή συνήθεια: πληκτρολογήστε εσείς «gov.gr» στον browser, αντί να πατήσετε τον σύνδεσμο.'
				},
				{
					id: 'acs-parcel-fee',
					channel: 'email',
				...
				},
				{
					...
					redFlags: [
						...
						'Ζητά στοιχεία κάρτας για «δώρο», ενώ κανένα πρόγραμμα πόντων δεν το κάνει αυτό.',
				...
				},
				{
					...
					takeaway:
						'Δεν θυμάστε την παραγγελία; Είναι απάτη. Μπείτε στο κατάστημα μόνοι σας για να ελέγξετε.'
				},
				{
					...
					takeaway:
						'Νόμιμο. Συνδεθείτε όπως πάντα, μέσα από την επίσημη εφαρμογή ή πληκτρολογώντας μόνοι σας τη διεύθυνση.'
				}
			]
		},
		enabled: true,
			...
			cards: [
				{
					...
					takeaway:
						'Ελέγξτε την οφειλή σας μόνοι σας στην επίσημη εφαρμογή/site της ΔΕΗ ή στον έντυπο λογαριασμό.'
				},
				{
					id: 'family-newnumber',
					channel: 'sms',
				...
				},
				{
					...
					isScam: true,
					redFlags: [
						'Υπόσχεση εύκολου, εγγυημένου κέρδους, που δεν υπάρχει στην πραγματικότητα.',
					...
					takeaway:
						'Καμία νόμιμη επένδυση δεν εγγυάται κέρδη. Αν ακούγεται πολύ καλό για να είναι αληθινό, είναι απάτη.'
				},
				{
					id: 'courier-customs',
					channel: 'sms',
					...
					takeaway:
						'Ελέγξτε την αποστολή σας μόνο στο επίσημο site/εφαρμογή της εταιρείας με τον πραγματικό αριθμό αποστολής.'
				},
				{
					id: 'kok-fine',
					channel: 'sms',
					...
					takeaway:
						'Αμφιβάλλετε; Μπείτε μόνοι σας στο gov.gr. Μην πατάτε τον σύνδεσμο του μηνύματος.'
				},
				{
					...
					isScam: false,
					redFlags: [
						'Επιβεβαιώνει ένα ραντεβού που εσείς κλείσατε και δεν ζητά τίποτα.',
					...
					takeaway:
						'Νόμιμο. Αν θέλετε αλλαγή, μπείτε μόνοι σας στο gov.gr αντί να απαντήσετε στο μήνυμα.'
				}
			]
		},
		enabled: true,
		...
		config: {
			...
			cards: [
				...
				},
				{
					...
					takeaway:
						'Αν ακούγεται πολύ καλό για να είναι αληθινό, είναι απάτη. Καμία σοβαρή επένδυση δεν εγγυάται κέρδη.'
				},
				{
					id: 'viber-prize',
					channel: 'viber',
				...
				},
				{
					...
					takeaway:
						'Μη βάζετε ποτέ κωδικούς κοινωνικών δικτύων σε σελίδες που ανοίγουν από λινκ μηνύματος.'
				},
				{
					id: 'viber-romance',
					channel: 'viber',
				...
				},
				{
					...
					explanation: 'Φυσιολογικό προσωπικό μήνυμα από φίλη. Δεν υπάρχει κανένα ύποπτο αίτημα.',
					takeaway:
						'Νόμιμο. Αν όμως ξαφνικά ζητούσε χρήματα ή κωδικό, θα άξιζε ένα τηλεφώνημα επιβεβαίωσης.'
				},
				{
		...
		config: {
			...
			cards: [
				...
				},
				{
					...
					takeaway:
						'Καμία εταιρεία δεν σας καλεί για ιούς. Κλείστε αμέσως και μην εγκαταστήσετε τίποτα.'
				},
				{
					id: 'phone-aade-debt',
					channel: 'phone',
				...
				},
				{
					...
					takeaway:
						'Αν πρέπει να πληρώσετε για να «κερδίσετε», είναι απάτη. Μη δίνετε ποτέ στοιχεία κάρτας τηλεφωνικά.'
				},
				{
					...
					takeaway:
						'Νόμιμο. Σε κάθε αμφιβολία, κλείνετε και καλείτε εσείς το επίσημο τηλέφωνο της τράπεζας.'
				},
				{
					...
					explanation: 'Φυσιολογική κλήση επιβεβαίωσης ραντεβού. Δεν υπάρχει κανένα ύποπτο αίτημα.',
					takeaway:
						'Νόμιμο. Αν δεν θυμάστε το ραντεβού, καλέστε εσείς το κέντρο στο γνωστό του τηλέφωνο.'
				}
			]
		},
		enabled: true,
