...
const _modules: Omit<NewModule, 'orderIndex' | 'createdAt'>[] = [
	...
	{
		id: 'module6',
		titleKey: 'module6_title',
		descriptionKey: 'module6_description',
		iconName: 'Mail',
		enabled: true
	},
	{
		id: 'word',
		titleKey: 'word_title',
		descriptionKey: 'word_description',
		iconName: 'FileText',
		enabled: true
	},
	{
		id: 'module7',
		titleKey: 'module7_title',
		descriptionKey: 'module7_description',
		iconName: 'Grid3X3',
		enabled: true
	},
	{
		id: 'module8',
		titleKey: 'module8_title',
		descriptionKey: 'module8_description',
		iconName: 'Shield',
		enabled: true
	},
	{
		id: 'module9',
		titleKey: 'module9_title',
		descriptionKey: 'module9_description',
		iconName: 'Settings',
		enabled: true
	},
	{
		id: 'module10',
		titleKey: 'module10_title',
		descriptionKey: 'module10_description',
		iconName: 'AlertTriangle',
		enabled: true
	},
	{
		id: 'module11',
		titleKey: 'module11_title',
		descriptionKey: 'module11_description',
		iconName: 'Video',
		enabled: true
	},
	{
		id: 'module12',
		titleKey: 'module12_title',
		descriptionKey: 'module12_description',
		iconName: 'Building2',
		enabled: true
	},
	{
		id: 'module13',
		titleKey: 'module13_title',
		descriptionKey: 'module13_description',
		iconName: 'Bot',
		enabled: true
	},
	{
		...
		descriptionKey: 'android_description',
		iconName: 'Smartphone',
		enabled: true
	},
	{
		id: 'iphone',
		titleKey: 'iphone_title',
		descriptionKey: 'iphone_description',
