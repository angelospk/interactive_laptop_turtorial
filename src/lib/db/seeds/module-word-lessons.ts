...
const _wordLessons: Omit<NewLesson, 'orderIndex' | 'requiredLessonId'>[] = [
	...
	},
	{
		...
		config: {
			...
			instructions:
				'Επιλέξτε το όνομα "Ιωάννης Παπαδόπουλος" και πατήστε U (Underline) για υπογράμμιση.'
		},
		enabled: true
	},
	{
		...
		config: {
			...
			initialText: 'ΑΙΤΗΣΗ\n\nΑξιότιμε κύριε,\n\nΠροσόντα μου:\n',
			instructions:
				'Πατήστε το κουμπί λίστας με κουκίδες (bullet list) για να δημιουργήσετε μια λίστα.'
		},
		enabled: true
	},
	{
