...
export const module2Lessons: NewLesson[] = [
	...
	// Lesson 9: Function Keys - Disabled
	{
		...
		// Disabled: on a laptop these keys sit behind Fn and collide with browser
		// and OS shortcuts, so the drill cannot be made reliable for the target
		// audience. Kept rather than deleted so existing progress rows survive;
		// whether it ships is a content decision (docs/LESSON_REVIEW.md).
		enabled: false,
