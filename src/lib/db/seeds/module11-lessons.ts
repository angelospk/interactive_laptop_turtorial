...
export const module11Lessons: NewLesson[] = [
	...
	// Lesson 2: Open Video Call App
	{
		...
		config: {
			...
			targetAppId: 'viber',
			instructions:
				'Ανοίξτε το Viber: Κάντε διπλό κλικ στο εικονίδιο Viber στην επιφάνεια εργασίας.'
		},
		enabled: true,
	...
	// Lesson 3: Start a Video Call
	{
		...
		config: {
			...
			initialApps: ['viber'],
			instructions:
				'Ξεκινήστε βιντεοκλήση: Επιλέξτε μια επαφή και πατήστε το εικονίδιο βιντεοκλήσης (📹).'
		},
		enabled: true,
	...
	// Lesson 4: Mute/Unmute
	{
		...
		config: {
			...
			initialApps: ['viber'],
			instructions:
				'Σίγαση μικροφώνου: Κατά τη διάρκεια κλήσης, πατήστε το εικονίδιο μικροφώνου 🎤 για να κάνετε σίγαση.'
		},
		enabled: true,
	...
	// Lesson 5: End Call
	{
		...
		config: {
			...
			initialApps: ['viber'],
			instructions:
				'Τερματισμός κλήσης: Πατήστε το κόκκινο κουμπί 📵 για να τερματίσετε τη βιντεοκλήση.'
		},
		enabled: true,
