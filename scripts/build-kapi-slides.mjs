...
/* =====================================================================
   ΜΑΘΗΜΑ 5 — Ρυθμίζω το κινητό μου
   ===================================================================== */
const L5 = '#b45309';
const lesson5 = [
	slide(1, 'Μάθημα 5 · Το κινητό μου', 'Ρυθμίζω το κινητό στα μέτρα μου',
		stack(
			rule('📱 Το κινητό ρυθμίζεται όπως <b>σας</b> βολεύει — να μην κλειδώνει συνέχεια, να βλέπετε άνετα, να κρατάει η μπαταρία.'),
			grid(
				card('👋', 'Τι θα κάνουμε σήμερα', `<p class="big">Δεν θα μάθουμε κάτι «δύσκολο». Θα ανοίξουμε τις <b>Ρυθμίσεις</b> και θα φτιάξουμε 4-5 πράγματα που ενοχλούν στην καθημερινότητα.</p>`),
				card('🧭', 'Μικρή σημείωση', plainList([
					'Κάθε κινητό γράφει τα μενού <b>λίγο αλλιώς</b>.',
					'Ψάχνουμε την <b>ίδια λέξη</b> (π.χ. «Οθόνη», «Μπαταρία»).',
					'Αν δεν τη βρίσκουμε, χρησιμοποιούμε την <b>αναζήτηση</b> 🔍 μέσα στις Ρυθμίσεις.'
				]))
			)
		)
	),
	slide(2, 'Μάθημα 5 · Προσανατολισμός', 'Τι θα μάθουμε σήμερα',
		grid(
			card('🎯', 'Στόχοι', tips([
				'Να μη <b>κλειδώνει</b> η οθόνη πολύ γρήγορα.',
				'Να ρυθμίζω <b>φωτεινότητα</b> &amp; νυχτερινή λειτουργία.',
				'Να <b>κρατάει</b> περισσότερο η μπαταρία.',
				'Να <b>κλειδώνω</b> το κινητό με ασφάλεια.'
			])),
			card('💬', 'Λεξιλόγιο της ημέρας', etym([
				['Ρυθμίσεις (Settings):', 'το «γρανάζι» ⚙️ — εκεί τα φτιάχνουμε όλα.'],
				['Οθόνη αναμονής:', 'η κλειδωμένη οθόνη που βλέπουμε πρώτη.'],
				['Μπαταρία:', 'η ενέργεια που «κρατάει» αναμμένο το κινητό.']
			]))
		)
	),
	slide(3, 'Μάθημα 5 · Οθόνη', 'Κλειδώνει πολύ γρήγορα; Το φτιάχνουμε',
		stack(
			rule('😤 Το πιο συχνό παράπονο! Η οθόνη σβήνει μόνη της σε λίγα δευτερόλεπτα — αλλάζει εύκολα.'),
			grid(
				card('⏱️', 'Βήμα-βήμα', steps([
					'Ανοίγω τις <b>Ρυθμίσεις ⚙️</b>.',
					'Πάω στο <b>«Οθόνη»</b> (Display).',
					'Βρίσκω <b>«Χρόνος αναμονής»</b> ή <b>«Αυτόματο κλείδωμα»</b>.',
					'Διαλέγω μεγαλύτερο χρόνο — π.χ. <b>2 ή 5 λεπτά</b>.'
				])),
				card('💡', 'Καλό να ξέρω', `<p class="big">Μεγάλος χρόνος = πιο βολικό, αλλά τρώει <b>λίγη παραπάνω μπαταρία</b>. Τα 2 λεπτά είναι καλή ισορροπία.</p>`)
			)
		)
	),
	slide(4, 'Μάθημα 5 · Φωτεινότητα', 'Βλέπω άνετα — μέρα &amp; νύχτα',
		grid(
			card('☀️', 'Φωτεινότητα', tips([
				'Σύρω το δάχτυλο <b>από πάνω προς τα κάτω</b> και κινώ τη μπάρα <b>☀️</b>.',
				'<b>Αυτόματη φωτεινότητα:</b> προσαρμόζεται μόνη της στο φως του χώρου.',
				'Στον ήλιο ανεβάζω, στο σπίτι κατεβάζω.'
			])),
			card('🌙', 'Νυχτερινή λειτουργία', tips([
				'<b>Νυχτερινό φως:</b> πιο ζεστά (κιτρινωπά) χρώματα το βράδυ — <b>ξεκουράζει τα μάτια</b>.',
				'<b>Σκούρο θέμα (Dark mode):</b> μαύρο φόντο, λιγότερο φως στα μάτια.',
				'Ρυθμίσεις → Οθόνη → «Νυχτερινό φως» / «Σκούρο θέμα».'
			]))
		)
	),
	slide(5, 'Μάθημα 5 · Μπαταρία', 'Να κρατάει περισσότερο',
		grid(
			card('🔋', 'Εξοικονόμηση ενέργειας', tips([
				'<b>Τι κάνει:</b> κόβει πράγματα που τρέχουν «από πίσω» (background) → κρατάει περισσότερο.',
				'<b>Πού:</b> Ρυθμίσεις → Μπαταρία → <b>«Εξοικονόμηση ενέργειας»</b>.',
				'<b>Πότε:</b> όταν η μπαταρία είναι χαμηλά και δεν έχω φορτιστή κοντά.',
				'Μπορεί να ανάβει <b>μόνη της</b> κάτω από π.χ. 20%.'
			])),
			check([
				'Σβήνει πολύ γρήγορα η μπαταρία σας;',
				'Έχετε δει την ένδειξη ποσοστού (%) πάνω-πάνω;',
				'Φορτίζετε κάθε βράδυ;'
			])
		)
	),
	slide(6, 'Μάθημα 5 · Φόρτιση', 'Powerbank &amp; καλές συνήθειες',
		grid(
			card('🔌', 'Η εφεδρική μπαταρία τσέπης', tips([
				'<b>Powerbank:</b> μια μπαταρία που κουβαλάμε και φορτίζει το κινητό <b>εν κινήσει</b>.',
				'Ανάλογα το μέγεθος, φορτίζει το κινητό <b>πολλές φορές</b> (μια χοντρή ~4-5 φορές).',
				'Χρήσιμο σε ταξίδι, εξοχή, νοσοκομείο — όπου δεν έχει πρίζα.'
			])),
			card('💚', 'Καλή συνήθεια φόρτισης', `<p class="big">Δεν χρειάζεται να φτάσει στο <b>0%</b>. Η μπαταρία «χαίρεται» όταν την κρατάμε γύρω στο <b>20%–80%</b>. Δεν πειράζει αν καμιά φορά γεμίσει στο 100%.</p>`)
		)
	),
	slide(7, 'Μάθημα 5 · Η μπαταρία παλιώνει', 'Φυσιολογική φθορά &amp; καλά νέα',
		grid(
			card('📉', 'Με τα χρόνια «κουράζεται»', tips([
				'Κάθε μπαταρία με τον καιρό <b>κρατάει λιγότερο</b> (degrade). Είναι <b>φυσιολογικό</b>, δεν χαλάσατε κάτι.',
				'Λύση: <b>αλλαγή μπαταρίας</b> (σε τεχνικό) ή νέο κινητό.',
				'Σημάδι: σβήνει πολύ πιο γρήγορα απ’ ό,τι όταν ήταν καινούριο.'
			])),
			card('🇪🇺', 'Καλά νέα από την Ευρώπη', `<p class="big">Από το <b>2027</b>, νέος ευρωπαϊκός νόμος υποχρεώνει τα νέα κινητά να έχουν μπαταρία που <b>αλλάζει εύκολα</b> — όπως παλιά. Το μέλλον είναι πιο βολικό.</p>`)
		)
	),
	slide(8, 'Μάθημα 5 · Καλώδια', 'Type-C: ένα καλώδιο για όλα',
		stack(
			rule('🔌 Η Ευρώπη όρισε <b>έναν κοινό φορτιστή</b>: το <b>USB-C (Type-C)</b>.'),
			grid(
				card('🧩', 'Τι σημαίνει για εμένα', tips([
					'Από το <b>τέλος του 2024</b>, τα νέα κινητά &amp; tablet στην ΕΕ φορτίζουν με <b>Type-C</b> — ακόμη και τα <b>iPhone</b>.',
					'<b>Ένα καλώδιο</b> για κινητό, tablet, πολλά laptop, ακόμη και ξυριστικές/οδοντόβουρτσες.',
					'<b>Λιγότερα καλώδια</b> στο σπίτι, λιγότερο μπέρδεμα.'
				])),
				card('📖', 'Ετυμολογία', etym([
					['USB:', 'ένα παγκόσμιο πρότυπο σύνδεσης συσκευών.'],
					['Type-C:', 'το βύσμα που μπαίνει &amp; από τις δύο πλευρές — δεν έχει «ανάποδα».']
				]))
			)
		)
	),
	slide(9, 'Μάθημα 5 · Ασφάλεια', 'Κλειδώνω το κινητό μου',
		grid(
			card('🔐', 'Τρόποι κλειδώματος', tips([
				'<b>Γιατί:</b> αν χαθεί ή κλαπεί, να μην μπει άλλος στα δικά μας.',
				'<b>PIN</b> (4-6 ψηφία): απλό &amp; σίγουρο.',
				'<b>Δαχτυλικό αποτύπωμα</b> 👆 ή <b>πρόσωπο</b>: ξεκλειδώνει στη στιγμή.',
				'Ρυθμίσεις → <b>Ασφάλεια</b> → «Κλείδωμα οθόνης».'
			])),
			card('💡', 'Συμβουλή', `<p class="big">Διαλέξτε PIN που θυμάστε, αλλά <b>όχι</b> 1234 ή τη χρονιά γέννησης. Κρατήστε τον κάπου ασφαλή — όχι κολλημένο στο κινητό.</p>`)
		)
	),
	slide(10, 'Μάθημα 5 · Ανακεφαλαίωση', 'Τι κρατάμε από σήμερα',
		grid(
			card('✅', 'Τα φτιάξαμε', tips([
				'Η οθόνη δεν κλειδώνει πια στη στιγμή.',
				'Ρυθμίζω φωτεινότητα &amp; νυχτερινό φως.',
				'Ξέρω την εξοικονόμηση μπαταρίας &amp; το powerbank.',
				'Κλειδώνω με PIN ή δαχτυλικό.'
			])),
			stack(
				goalCard('Το κινητό δουλεύει για εσάς — όχι εσείς για το κινητό. Όλα αλλάζουν από τις Ρυθμίσεις.'),
				refs(stack(ref('Ρυθμίσεις &amp; επίλυση:', '/modules/module9')))
			)
		)
	)
];
...
/* =====================================================================
   ΜΑΘΗΜΑ 6 — Τάξη στα μηνύματα + Έξυπνα εργαλεία
   ===================================================================== */
const L6 = '#0e7490';
const lesson6 = [
	slide(1, 'Μάθημα 6 · Τάξη &amp; Έξυπνα εργαλεία', 'Μηνύματα με τάξη + το κινητό μάς βοηθάει',
		stack(
			rule('🧹 Λίγη τάξη στα μηνύματα = ησυχία. Και το κινητό μπορεί να μας <b>θυμίζει</b> και να μας <b>βοηθάει</b> καθημερινά.'),
			grid(
				card('👋', 'Τι θα κάνουμε σήμερα', `<p class="big">Θα βάλουμε τάξη στα email (προώθηση, καθάρισμα, μπλοκάρισμα) και θα δούμε <b>έξυπνα εργαλεία</b>: μοίρασμα αρχείων, εύρεση χαμένου κινητού, ημερολόγιο και βοηθό AI.</p>`),
				card('🧭', 'Πώς θα πάμε', plainList([
					'Με την ησυχία μας, ένα-ένα.',
					'Δοκιμάζουμε μαζί σε αληθινό παράδειγμα.',
					'Ό,τι σας φανεί χρήσιμο, το ξανακάνουμε.'
				]))
			)
		)
	),
	slide(2, 'Μάθημα 6 · Προσανατολισμός', 'Τι θα μάθουμε σήμερα',
		grid(
			card('🎯', 'Στόχοι', tips([
				'Να <b>προωθώ</b> &amp; να <b>καθαρίζω</b> τα μηνύματα.',
				'Να <b>μπλοκάρω</b> ενοχλητικούς &amp; διαφημίσεις.',
				'Να <b>μοιράζομαι</b> αρχεία και να <b>βρίσκω</b> χαμένο κινητό.',
				'Να βάζω <b>υπενθυμίσεις</b> με το ημερολόγιο &amp; τον AI.'
			])),
			card('💬', 'Λεξιλόγιο της ημέρας', etym([
				['Προώθηση (forward):', 'στέλνω παρακάτω ένα μήνυμα που έλαβα.'],
				['Ανεπιθύμητα (spam):', 'ενοχλητικά/διαφημιστικά μηνύματα.'],
				['Κατάργηση εγγραφής (unsubscribe):', 'λέω «μη μου ξαναστέλνετε».']
			]))
		)
	),
	slide(3, 'Μάθημα 6 · Email', 'Προώθηση μηνύματος',
		grid(
			card('↪️', 'Στέλνω παρακάτω ένα μήνυμα', steps([
				'Ανοίγω το μήνυμα που θέλω.',
				'Πατάω <b>«Προώθηση»</b> (Forward).',
				'Στο <b>«Προς»</b> γράφω σε ποιον το στέλνω.',
				'Πατάω <b>«Αποστολή»</b>.'
			])),
			card('🔁', 'Απάντηση ή Προώθηση;', `<p class="big"><b>Απάντηση:</b> πάει πίσω σε αυτόν που μου έστειλε.<br/><b>Προώθηση:</b> στέλνει το ίδιο μήνυμα σε <b>νέο</b> πρόσωπο — π.χ. προωθώ στον λογιστή ένα email της εφορίας.</p>`)
		)
	),
	slide(4, 'Μάθημα 6 · Email', 'Καθάρισμα: διαγραφή &amp; φάκελοι',
		grid(
			card('🗑️', 'Διώχνω τα παλιά', tips([
				'Διαγραφή: το εικονίδιο <b>κάδος 🗑️</b>.',
				'Δεν χάνεται αμέσως — μένει λίγες μέρες στον <b>«Κάδο»</b>, αν το θέλω πίσω.',
				'<b>Πολλά μαζί:</b> κρατάω πατημένο ένα, επιλέγω κι άλλα, μετά διαγραφή.'
			])),
			card('🗂️', 'Βάζω σε φακέλους / ετικέτες', tips([
				'Βάζω τα σημαντικά σε φάκελο, π.χ. <b>«Τράπεζα»</b>, <b>«Γιατροί»</b>.',
				'Έτσι τα βρίσκω εύκολα, χωρίς ψάξιμο.',
				'Η <b>αναζήτηση 🔍</b> βρίσκει μήνυμα γράφοντας μια λέξη.'
			]))
		)
	),
	slide(5, 'Μάθημα 6 · Email', 'Μπλοκάρω ενοχλητικούς &amp; διαφημίσεις',
		stack(
			rule('🚫 Δεν χρειάζεται να τα ανέχεστε. Ένα-δύο πατήματα και ησυχάζετε.'),
			grid(
				card('⛔', 'Αποκλεισμός αποστολέα', steps([
					'Ανοίγω ένα μήνυμα του ενοχλητικού.',
					'Πατάω το μενού <b>(⋮)</b> πάνω δεξιά.',
					'Επιλέγω <b>«Αποκλεισμός»</b> (Block).',
					'Δεν ξαναέρχονται μηνύματά του.'
				])),
				card('✋', 'Unsubscribe από διαφημίσεις', `<p class="big">Στο <b>κάτω μέρος</b> των διαφημιστικών email υπάρχει μικρός σύνδεσμος <b>«Κατάργηση εγγραφής / Unsubscribe»</b>. Τον πατάω και σταματούν.<br/><span class="muted">Προσοχή: σε <b>ύποπτα/απάτες</b> δεν πατάω τίποτα — απλώς διαγράφω &amp; μπλοκάρω.</span></p>`)
			)
		)
	),
	slide(6, 'Μάθημα 6 · Μοίρασμα', 'Στέλνω αρχεία &amp; φωτογραφίες εύκολα',
		grid(
			card('📤', 'Το κουμπί «Κοινή χρήση»', tips([
				'Παντού υπάρχει το κουμπί <b>Κοινή χρήση (Share) ↗️</b> — σε φωτογραφίες, αρχεία, σελίδες.',
				'Πατάω <b>Share</b> → διαλέγω <b>πού</b>: Viber, email, Bluetooth.',
				'Παράδειγμα: στέλνω μια φωτογραφία στην κόρη μου με <b>2 πατήματα</b>.'
			])),
			check([
				'Ξέρετε πού είναι το κουμπί Share ↗️;',
				'Έχετε στείλει φωτογραφία σε δικό σας;',
				'Σε ποια εφαρμογή στέλνετε πιο συχνά;'
			])
		)
	),
	slide(7, 'Μάθημα 6 · Χαμένο κινητό', 'Το βρίσκω όταν χαθεί',
		stack(
			rule('🔎 Ρυθμίζεται <b>από πριν</b> — μια φορά, και είστε καλυμμένοι.'),
			grid(
				card('📍', 'Εύρεση συσκευής', tips([
					'Ενεργοποιώ από νωρίς το <b>«Εύρεση συσκευής»</b> (Find My Device / Find My).',
					'Αν χαθεί: από <b>άλλο κινητό ή υπολογιστή</b> μπαίνω στον λογαριασμό μου.',
					'Βλέπω <b>στον χάρτη</b> πού είναι — μπορώ να το κάνω να <b>χτυπήσει</b>, ακόμη κι αν είναι αθόρυβο.'
				])),
				card('✅', 'Προϋπόθεση', `<p class="big">Το κινητό να είναι <b>αναμμένο</b> &amp; στο <b>ίντερνετ</b>, και να έχω λογαριασμό <b>Google</b> (Android) ή <b>Apple</b> (iPhone).</p>`)
			)
		)
	),
	slide(8, 'Μάθημα 6 · Ημερολόγιο', 'Γεγονότα (events) &amp; εργασίες (tasks)',
		grid(
			card('📅', 'Δύο διαφορετικά πράγματα', tips([
				'<b>Γεγονός (event):</b> κάτι με <b>ώρα</b> — ραντεβού γιατρού, γιορτή, γάμος. Με <b>υπενθύμιση</b> πριν.',
				'<b>Εργασία (task):</b> κάτι που <b>έχω να κάνω</b> — «πληρωμή λογαριασμού». Το <b>τσεκάρω</b> όταν γίνει.',
				'<b>Πώς βοηθούν:</b> το κινητό μου <b>θυμίζει</b> — δεν ξεχνάω ραντεβού ούτε πληρωμές.'
			])),
			card('💡', 'Παράδειγμα', `<p class="big">Βάζω γεγονός «<i>Καρδιολόγος, Τρίτη 10:00</i>» με υπενθύμιση 1 ώρα πριν. Το κινητό με ειδοποιεί — ήσυχο κεφάλι.</p>`)
		)
	),
	slide(9, 'Μάθημα 6 · Βοηθός AI', 'Ζητάω από το κινητό να με βοηθήσει',
		stack(
			rule('🤖 Του μιλάω με <b>κανονικά λόγια</b> — γραπτά ή με <b>φωνή</b> 🎤.'),
			grid(
				card('✨', 'Τι μπορεί να κάνει', tips([
					'Βάζει <b>ξυπνητήρι</b> ή <b>χρονόμετρο</b> («βάλε ξυπνητήρι στις 7»).',
					'Φτιάχνει <b>υπενθύμιση</b> («θύμισέ μου αύριο στις 9 τα χάπια»).',
					'<b>Ψάχνει</b> κάτι για εμένα, ανοίγει εφαρμογή.',
					'<b>Παίρνει τηλέφωνο</b> μια επαφή, αν πω καθαρά το όνομα.'
				])),
				card('⚠️', 'Καλό να ξέρω', `<p class="big">Για κλήσεις/μηνύματα λέω <b>καθαρά</b> το όνομα της επαφής. Τα <b>SMS</b> μπορεί να έχουν χρέωση ανάλογα το πρόγραμμα. Για σημαντικά, <b>επιβεβαιώνω</b> μόνος μου.</p>`)
			)
		)
	),
	slide(10, 'Μάθημα 6 · Ανακεφαλαίωση', 'Τι κρατάμε — και τι δοκιμάζουμε',
		grid(
			card('✅', 'Τα πήραμε', tips([
				'Προωθώ, διαγράφω &amp; μπλοκάρω μηνύματα.',
				'Μοιράζομαι αρχεία με το κουμπί Share.',
				'Ξέρω πώς να βρω χαμένο κινητό.',
				'Βάζω υπενθυμίσεις με ημερολόγιο &amp; AI.'
			])),
			stack(
				card('🤝', 'Χωρίς ντροπή', `<p class="big">Διαλέξτε <b>ένα</b> πράγμα να δοκιμάσετε σπίτι αυτή τη βδομάδα. Με την επανάληψη γίνεται συνήθεια.</p>`),
				refs(stack(ref('Βοηθοί AI:', '/modules/module13')))
			)
		)
	)
];
...
const LESSONS = [
	...
	{ n: 5, file: 'mathima-5.html', accent: L5, kicker: 'Το κινητό μου', title: 'Ρυθμίσεις, Οθόνη &amp; Μπαταρία', count: lesson5.length, emoji: '📱' },
	{ n: 6, file: 'mathima-6.html', accent: L6, kicker: 'Τάξη &amp; Έξυπνα εργαλεία', title: 'Μηνύματα, Ημερολόγιο &amp; AI', count: lesson6.length, emoji: '🤖' }
];
function indexPage() {
...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<script>
  // Web: σταθερή βάση /kapi/ ώστε τα links να δουλεύουν ΚΑΙ χωρίς κάθετο (/kapi).
  // Offline (file://): δεν κάνουμε τίποτα — τα links μένουν σχετικά.
  if (location.protocol !== 'file:') document.write('<base href="/kapi/">');
</script>
...
<div class="wrap">
  <div class="hero">
    ...
    <p>${LESSONS.length} μαθήματα για το ΚΑΠΗ — με την ησυχία μας, βήμα-βήμα.</p>
  </div>
...
deck({ file: 'mathima-5.html', title: 'Μάθημα 5 — Ρυθμίσεις, Οθόνη & Μπαταρία', accent: L5, slidesHtml: lesson5 });
deck({ file: 'mathima-6.html', title: 'Μάθημα 6 — Μηνύματα, Ημερολόγιο & AI', accent: L6, slidesHtml: lesson6 });
indexPage();
