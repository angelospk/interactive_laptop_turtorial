...
export const module7Lessons: NewLesson[] = [
	...
	},
	{
		...
		config: {
			...
			targetValue: 'Ποσό (€)',
			instructions:
				'Κάντε κλικ στο κελί A1 και γράψτε "Κατηγορία". Πατήστε Tab, μετά γράψτε "Ποσό (€)" στο B1 και πατήστε Enter.'
		},
		enabled: true,
	...
	},
	{
		...
		config: {
			...
			targetValue: '450',
			instructions:
				'Κάντε κλικ στο κελί A2, γράψτε "Ενοίκιο" και πατήστε Tab. Μετά γράψτε "450" στο B2 και πατήστε Enter.'
		},
		enabled: true,
	...
	},
	{
		...
		config: {
			...
			instructions:
				'Επιλέξτε τα κελιά A1 και B1 (κλικ στο A1, μετά Shift+κλικ στο B1) και πατήστε το κουμπί "B" για να γίνουν έντονα.'
		},
		enabled: true,
	...
	},
	{
		...
		config: {
			...
			instructions:
				'Κάντε κλικ στο κελί B7. Γράψτε τον τύπο: =SUM(B2:B6) και πατήστε Enter για να υπολογίσετε το σύνολο των εξόδων.'
		},
		enabled: true,
	...
	},
	{
		...
		config: {
			...
			instructions:
				'Κάντε κλικ στο κελί B8. Γράψτε: =AVERAGE(B2:B6) και πατήστε Enter για να βρείτε τον μέσο μηνιαίο λογαριασμό.'
		},
		enabled: true,
	...
	},
	{
		...
		config: {
			...
			instructions:
				'Κάντε κλικ στο κελί B9. Γράψτε: =MAX(B2:B6) και πατήστε Enter για να βρείτε τη μεγαλύτερη δαπάνη.'
		},
		enabled: true,
	...
	},
	{
		...
		config: {
			...
			instructions:
				'Κάντε κλικ στο κελί B10. Γράψτε: =MIN(B2:B6) και πατήστε Enter για να βρείτε τη μικρότερη δαπάνη.'
		},
		enabled: true,
